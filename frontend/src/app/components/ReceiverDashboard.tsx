            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex min-w-0 items-start justify-between gap-3 sm:items-center">
                <div className="min-w-0 flex-1 pt-0.5 sm:pt-0">
                  <h1 className="break-words text-xl font-black leading-tight tracking-tight sm:text-2xl md:text-3xl">Welcome back, {currentProfile.name || displayName}</h1>
...
function ProfileCard({ profile, initials, savedFoods, onViewSaved, onClose, onLogout }: { profile: ProfileResponse; initials: string; savedFoods: FoodDonation[]; onViewSaved: (food: FoodDonation) => void; onClose: () => void; onLogout: () => void }) {
  return (
    <section className="fixed right-4 top-20 z-[80] w-[min(390px,calc(100vw-2rem))] overflow-hidden rounded-3xl border border-[#E5E7EB] bg-white shadow-[0_20px_50px_rgba(15,23,42,.16)] dark:border-white/[.08] dark:bg-[#020617] dark:shadow-[0_20px_50px_rgba(0,0,0,.65)] md:right-8 md:top-24">
      ...
      <div className="max-h-[260px] overflow-y-auto bg-white p-4 dark:bg-[#020617]">
